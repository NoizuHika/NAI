...
int main(int argc, char **argv) {
    ...
    while (waitKey(10) != 27) {
        ...
        inRange(dst, lower, upper, crn);
        auto kern = getStructuringElement(MORPH_ELLIPSE, {10, 10});
        morphologyEx(crn, crn, MORPH_CLOSE, kern);
        morphologyEx(crn, crn, MORPH_OPEN, kern);
        ...
        findContours(crn, contours, RETR_LIST, CHAIN_APPROX_SIMPLE);
